 ...
 * postMessage contract). These test the modules DIRECTLY — no demo UI — so
 * they survive clean_out_template.sh and keep guarding the contract in a
 * cleaned-out app. Demo-UI coverage lives in App.test.tsx (deleted by the
 * cleanout).
 */
