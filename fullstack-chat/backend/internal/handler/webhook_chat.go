...
// app's own concern. The demo wires a Postgres sink (webhook_sink_demo.go);
// clean_out_template.sh swaps in a log-only sink you replace with your own.
...
// and stores nothing. Used by the clean template twin until the app wires
// a real sink.
