...
// caller-context only and drives the 403 cross-check on writes — see the
// load-bearing strictTenantCheckEnabled/enforceTenantMatch helpers in
// tenant.go (they survive the demo cleanout).
