...
// Direct unit tests for the tenant-contract helpers (CHAT-pxeo.12). These
// survive clean_out_template.sh — the helpers are platform plumbing, so the
// contract must stay covered even after the demo handlers are removed.
