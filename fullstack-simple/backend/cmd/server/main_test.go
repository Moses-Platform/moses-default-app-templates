...
// Contract tests for the Moses plumbing surface (health + openapi + the
// spec↔mux lock). They pass with ZERO application routes; as you add real
// endpoints, extend them (see the deleted demo's tests in git history for
// route-probing examples).
